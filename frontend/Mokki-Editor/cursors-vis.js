(function(){
    ...
    function moveCaret(key, rect, editor){
        let scrollHeight = 0;
    ...
    function createDrag(key, rect, editor){
        let scrollHeight = 0;
        if(editor.scrollHeight == editor.clientHeight){
            scrollHeight = caretContainer.offsetTop;
        }
    ...
    function setUserCaret(editorEl,sessionId, start, end){
    ...
    function calcUserCaret(element, start, end, key){
